            ...
            <div>
                <div className="d-flex flex-row align-items-start">
                    <div className="profile-image-container">
                        <img src={Y} id="profileImage" className="img-thumbnail shadow" alt="Profile Image" />
                ...
                <div className="row">
                    <div className="col-9">
                        <div className="user-id-container mt-1">
                            Your user id is: <span className="user-id" role="button">#202036</span>
                        </div>
                        <form>
                            <div className="form-group row mt-2">
                                <div className="col-6">
                                    <label htmlFor="firstname" className="col-form-label">Firstname</label>
                                    <input type="text" name="firstname" className="form-control shadow-sm" id="firstname" value="JohnDoe" />
                                </div>
                                <div className="col-6">
                                    <label htmlFor="lastname" className="col-form-label">Lastname</label>
                                    <input type="text" className="form-control shadow-sm" name="lastname" id="lastname" value="JohnDoe" />
                                </div>
                            </div>
                            <div className="form-group row">
                                <div className="col-6">
                                    <label htmlFor="gender" className="col-form-label">Gender</label>
                                    <select name="gender" id="gender" className="form-select shadow-sm" aria-label="Default select example">
                            ...
                            <div className="form-group row">
                                <div className="col-6">
                                    ...
                                    <input type="date" name="birthdate" className="form-control shadow-sm" id="birthdate" />
                                </div>
                            </div>
                            <div className="form-group row">
                                <div className="col-12" title="You cannot change the email you signed up with">
                                    ...
                                    <input type="email" name="email" className="form-control shadow-sm" value="youssefmoustaid@gmail.com" id="email" disabled />
                                </div>
                            </div>
                            <div className="form-group mt-2">
                                <label htmlFor="password">Password</label>
                                <div className="input-group">
                                    <input type="password" id="password" className="form-control shadow-sm" value="aaaaaaaa" />
                                    <div className="input-group-append h-100">
                                        <span className="input-group-text shadow-sm py-2" role="button" id="togglePassword">
