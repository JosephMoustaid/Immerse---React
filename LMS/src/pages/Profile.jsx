                ...
                <div   className="row">
                    <div   className="col-9">
                        <div   className="user-id-container mt-1">
                            Your user id is: <span   className="user-id" role="button">{props.user.id}</span>
                        </div>
                        <form>
                            <div   className="form-group row mt-2">
                                <div   className="col-6">
                                    <label htmlFor="firstname"   className="col-form-label">Firstname</label>
                                    <input type="text" name="firstname"   className="form-control shadow-sm" id="firstname" value={props.user.firstname} />
                                </div>
                                <div   className="col-6">
                                    <label htmlFor="lastname"   className="col-form-label">Lastname</label>
                                    <input type="text"   className="form-control shadow-sm" name="lastname" id="lastname" value={props.user.lastname} />
                                </div>
                            </div>
                            <div   className="form-group row">
                                <div   className="col-6">
                                    ...
                                    <select name="gender" id="gender"   className="form-select shadow-sm" aria-label="Default select example">
                                        ...
                                        <option value="male" selected={props.user.gender === 'm'}>Male</option>
                                        <option value="female" selected={props.user.gender === 'f'}>Female</option>
                                    </select>
                                </div>
                            </div>
                            <div   className="form-group row">
                                <div   className="col-6">
                                    ...
                                    <input type="date" name="birthdate"   className="form-control shadow-sm" id="birthdate" value={props.user.birthdate} />
                                </div>
                            </div>
                            <div   className="form-group row">
                                <div   className="col-12" title="You cannot change the email you signed up with">
                                    ...
                                    <input type="email" name="email"   className="form-control shadow-sm" value={props.user.email} id="email" disabled />
                                </div>
                            </div>
